...
const translations = {
  zh: {
    ...
    // Minecraft 營隊教學網站
    mcSite: {
      projectTitle: "Minecraft 營隊互動教學網站",
      pcOnly: "⚠️ 僅支援 PC 端網頁使用",
      projectTime: "大四寒假",
      projectSubtitle: "五日創客夏令營 | 面向 10–14 歲青少年",
      introTitle: "專案背景",
      introContent:
        "本專案為一套完整的五日 Minecraft 創客夏令營教學網站，面向 10–14 歲青少年。設計核心是以「遊戲化學習」取代傳統投影片教學，讓學生在互動操作中自然建立美學、邏輯、程式設計與企劃能力。",
      curriculumTitle: "課程架構",
      curriculumDesc: "網站以單頁應用（SPA）架構組織五個主題日：",
      tableDay: "Day",
      tableTheme: "主題",
      tableSkill: "核心技能",
      day1Theme: "基礎美學訓練",
      ...
      day2Skill: "工程製圖、空間想像",
      day3Theme: "邏輯與程式設計",
      day3Skill: "AI Prompt 工程、Python 基礎",
      day4Theme: "互動小遊戲開發",
      day4Skill: "Minecraft 指令、遊戲設計流程",
      day5Theme: "剪輯與作品展示",
      day5Skill: "影片剪輯、成果發表",
      techTitle: "技術實作亮點",
      tech1Title: "6 個原創互動小遊戲",
      tech1p1: "色塊辨識遊戲（含計時器、計分、即時音效回饋）",
      tech1p2: "自由幾何創作畫布（拖放式介面）",
      tech1p3: "色彩理論打地鼠",
      tech2Title: "三視圖繪圖工具",
      tech2p1: "Canvas API 實作前視圖／俯視圖／側視圖三畫布同步繪製",
      tech2p2: "支援 JPG 匯出功能",
      tech3Title: "Web Audio API 音效系統",
      tech3p1: "無需音樂檔案，以程式合成正確、錯誤、勝利等互動音效",
      tech4Title: "AI 提示詞教學模組",
      tech4p1: "內建一鍵複製的 GitHub Copilot Prompt",
      tech4p2: "引導學生以 AI 完成 Python 開發任務",
      tech5Title: "Minecraft 指令速查表",
      tech5p1: "互動式複製按鈕，降低課堂操作摩擦",
      tech6Title: "遊戲企劃拉霸機",
      tech6p1: "隨機生成情境 × 目標 × 限制三要素，激發學生創意",
      uxTitle: "UX 設計",
      uxContent:
        "採用 Minecraft 像素風格結合現代 glassmorphism 元素，搭配 Fredoka / Varela Round 圓潤字型，SweetAlert2 彈窗與 Confetti 粒子慶祝效果，整體介面活潑易用。導覽欄支援分頁切換，並在切換至 Day 2 時自動初始化 Canvas 環境。",
      architectureTitle: "開發架構圖",
      archLayer1: "SPA 前端介面層",
      archLayer2: "互動功能層",
      archLayer3: "課程資源層",
      archComp1: "像素風 UI",
      archComp2: "AI Prompt 庫",
      archComp3: "Minecraft 速查",
      archComp4: "學員作品收集",
      resultTitle: "成果",
      resultContent:
    ...
    teachingDesign: {
      ...
      minecraftCourse: {
        ...
        overviewText:
          "本專案為針對國中小學生設計的五日全天營隊，旨在打破單純「玩遊戲」的框架，將 Minecraft 轉化為設計思考與程式邏輯的載體。課程內容橫跨藝術美學、建築結構、使用者體驗設計（UX）與程式運算。",
        keyOutcomes: "🎯 核心成果 (Key Outcomes)",
        gameDesign: "Minecraft 遊戲關卡設計",
        gameDesignText:
          "區別於一般的建築堆疊，本課程引導學生思考「遊戲性」與「動線規劃」。學生需應用所學的透視與結構知識，在 Minecraft 中從零打造具備挑戰性的互動關卡，並進行成果展示與試玩。",
        innovation: "💡 技術與教學創新 (Technical & Pedagogical Innovation)",
        innovationText:
          "為了提升教學品質並解決小學生在多種數位工具間切換的困難，我在課程前置作業中導入了 Web Development 技術：",
        webSystem: "🌐 開發專屬教學輔助網站 (Web-based Support System)",
        webSystemText:
          "我獨立架設了 Minecraft 課程資源站。這個網站成為了五天營隊的數位核心，具備以下功能：",
        feature1: "資源整合中心：結構化整理每日課程所需的素材與軟體連結。",
        feature2:
          "AI 輔助學習：內建經測試優化的 AI 提示詞（Prompt）庫，讓學生能直接複製使用，體驗生成式 AI 在設計流程中的應用。",
        feature3:
          "工具導流：整合 SketchUp、Figma、Vibe Coding 等外部工具入口，實現無縫的教學體驗。",
  ...
  en: {
    ...
    // Minecraft Camp Interactive Teaching Website
    mcSite: {
      projectTitle: "Minecraft Camp Interactive Teaching Website",
      pcOnly: "⚠️ Optimized for PC browsers only",
      ...
      day1Theme: "Foundational Aesthetics",
      day1Skill: "Color Theory, Spatial Composition",
      day2Theme: "Three-View Architect",
      day2Skill: "Engineering Drawing, Spatial Imagination",
      day3Theme: "Logic & Programming",
      day3Skill: "AI Prompt Engineering, Python Basics",
      day4Theme: "Interactive Mini-Game Dev",
      day4Skill: "Minecraft Commands, Game Design Process",
      day5Theme: "Editing & Showcase",
      ...
      archLayer3: "Course Resource Layer",
      archComp1: "Pixel Art UI",
      archComp2: "AI Prompt Library",
    ...
    teachingDesign: {
      ...
      minecraftCourse: {
        title:
          "Minecraft: Maker Design Challenge - From Aesthetic Concepts to Virtual Level Design",
        overview: "📖 Overview",
        overviewText:
          "This project is a five-day full-day camp designed for elementary and junior high school students, aiming to break the framework of simply 'playing games' and transform Minecraft into a carrier of design thinking and programming logic. The course content spans art aesthetics, architectural structure, user interface design (UI), and programming concepts.",
        keyOutcomes: "🎯 Key Outcomes",
        gameDesign: "Minecraft Game Level Design",
        gameDesignText:
          "Unlike general building stacking, this course guides students to think about 'gameplay' and 'route planning.' Students need to apply the perspective and structural knowledge they have learned to build challenging interactive levels from scratch in Minecraft, and conduct result demonstrations and playtesting.",
        innovation: "💡 Technical & Pedagogical Innovation",
        innovationText:
          "To improve teaching quality and solve the difficulty of elementary school students switching between multiple digital tools, I introduced Web Development technology in course preparation:",
        webSystem: "🌐 Web-based Support System",
        webSystemText:
          "I independently set up a Minecraft course resource site. This website became the digital core of the five-day camp with the following functions:",
        feature1:
          "Resource Integration Center: Structurally organize materials and software links required for daily courses.",
        feature2:
          "AI-Assisted Learning: Built-in tested and optimized AI prompts library, allowing students to copy and use directly, experiencing the application of generative AI in the design process.",
        feature3:
          "Tool Navigation: Integrate external tools such as SketchUp, Figma, Vibe Coding to achieve a seamless teaching experience.",
        ...
        day3Text:
          "Server setup, Python GUI scoring program analysis, fishing score competition.",
        day4: "📅 Day 4 - Level Development Practice",
        day4Text:
          "Game mechanism ideation, sketch drawing, Minecraft level construction and decoration.",
